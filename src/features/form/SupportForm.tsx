...
export default function SupportForm() {
  ...
  return (
    <form
      ...
      className="max-w-2xl mx-auto p-8 space-y-8 bg-white rounded-xl shadow-lg"
    >
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800">Support Request</h2>
